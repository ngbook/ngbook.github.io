...
var AppComponent = (function () {
    ...
    AppComponent.prototype.imgHover = function () {
        __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent(this.logo.nativeElement, 'mousemove')
            .switchMap(function (event) {
            console.log('mousemove');
            return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].timer(500).map(function (e) { return event; });
        })
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_1" /* ViewChild */])('logo'),
